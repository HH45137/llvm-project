...
ThreadStateTy::ThreadStateTy()
    : PerThreadDeviceDefaultStreamMap(AssumedDeviceCount) {
...
StateTy::StateTy()
    : DeviceDefaultStreamsMap(AssumedDeviceCount),
      DeviceStreamsMap(AssumedDeviceCount),
      DeviceBlockingStreamsMap(AssumedDeviceCount) {
